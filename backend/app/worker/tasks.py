...
from app.worker.celery_app import celery_app, DATABASE_URL, BACKEND_URL
from app.worker.scanner import scan_url, ScanResult
...
def process_scan(self, scan_id: int, url: str):
    ...
    try:
        ...
        if allow_active:
            try:
                from app.worker.zap_client import zap_baseline_scan, is_zap_available
